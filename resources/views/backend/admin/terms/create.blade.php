                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="content" rows="12" class="form-control" placeholder="Enter the terms and conditions that will appear on invoices">{{ old('content') }}</textarea>
                                            <small class="form-text text-muted">Keep it concise. HTML is allowed but will be escaped when printed.</small>
                                        </div>
                                    </div>
