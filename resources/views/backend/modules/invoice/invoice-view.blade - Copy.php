    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="container-fluid px-3 d-flex justify-content-center align-items-center" style="min-height: 100vh; padding-top: 30px;">
            <div class="invoice-box w-100" id="invoice" style="max-width: 900px; margin: 0 auto;">
                ...
                <h3 class="mb-3 fw-bold">Invoice Details</h3>
                ...
                <table id="view-invoice" class="table table-striped table-bordered align-middle">
                    ...
                    <td data-label="Description"><span class="mobile-value">{{ $item->product_name ?? '-' }}</span></td>
                    <td data-label="HSN"><span class="mobile-value">{{ $item->product->hsn_code ?? '-' }}</span></td>
                    <td data-label="serial_no"><span class="mobile-value">{{ $item->serial_no ?? '-' }}</span></td>
                ...
                <div class="container mb-5 mt-5" id="invoice">
                  <div class="p-4 rounded-4 shadow-sm border bg-white">
                    <h4 class="fw-bold text-center text-uppercase text-dark mb-4">
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-md-6">
                        <div
                          ...
                          style="background: linear-gradient(to right, #f0f4ff, #e2e6f0);
                          ...
                          <p class="mb-2">
                            <strong class="text-secondary">A/C Number:</strong>
                            {{ $invoice->warehouse->account_number ?? '-' }}
                          </p>
                          <p class="mb-2">
                            <strong class="text-secondary">Account Holder:</strong>
                            {{ $invoice->warehouse->account_name ?? '-' }}
                          </p>
                          <p>
                            <strong class="text-secondary">IFSC Code:</strong>
                            {{ $invoice->warehouse->ifsc_code ?? '-' }}
                          </p>
                          <p>
                            <strong class="text-secondary">Branch:</strong>
                            {{ $invoice->warehouse->branch ?? '-' }}
                          </p>
                        </div>
                      </div>
                ...
                <div class="row mt-5" style="border-top: 2px solid #000; padding-top: 15px;">
                    <div class="col-md-6">
