            ...
            <div class="card shadow-sm rounded-4 mt-4">
                <div class="card-body">
                    <div class="row align-items-center mb-4">
                        <div class="col-md-6">
                            <h4 class="mb-0">{{ $heading }} ({{ $enquiry->enquiry_number }})</h4>
                        </div>
                    </div>

                    @include('backend.include.formError')

                    <form action="{{ route('enquiries.update', $enquiry->id) }}" method="POST" class="row g-4">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="city" id="city" class="form-select select2" required>
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->id }}" {{ old('city', $enquiry->city_id) == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea name="product_interest" id="productInterest" class="form-control mt-2" rows="2" placeholder="Selected products will appear here...">{{ old('product_interest', $enquiry->product_interest) }}</textarea>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="remarks" rows="2" placeholder="Any additional notes...">{{ old('remarks', $enquiry->remarks) }}</textarea>
                        </div>
