                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('leads.store') }}" method="POST" class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="product_interest" id="productInterest" class="form-control mt-2" rows="2" placeholder="Products interested in...">{{ old('product_interest', $enquiry->product_interest ?? '') }}</textarea>
                        </div>
                        <div class="col-md-6">
